...
return {"nvim-telescope/telescope.nvim", dependencies = {{"nvim-lua/popup.nvim"}, {"nvim-lua/plenary.nvim"}}, extensions = {projects = {projects = {}}, yank_history = {}}, pickers = {buffers = {mappings = {n = {d = "delete_buffer"}}}}, version = "*"}
